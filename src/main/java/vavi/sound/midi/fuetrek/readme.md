...
| name                         | status | comment                                                |
|------------------------------|:------:|--------------------------------------------------------|
| Fuetrek UCS MIDI Synthesizer |   ✅️   | the rom read out of `rt_synth_4.dll`, ~40ms of latency |

## Usage

```java
Synthesizer synthesizer = MidiSystem.getMidiDevice(info); // "Fuetrek MIDI Synthesizer"
synthesizer.open();
sequencer.getTransmitter().setReceiver(synthesizer.getReceiver());
```

`rt_synth_4.dll` has to be where [`vavi.sound.mfi.fuetrek`](../../mfi/fuetrek/readme.md) looks for
...
| `f0 45 04 ...`                | the mfi values of vavi, see [`vavi.sound.mfi.fuetrek`](../../mfi/fuetrek/readme.md)                                                                                                  |
