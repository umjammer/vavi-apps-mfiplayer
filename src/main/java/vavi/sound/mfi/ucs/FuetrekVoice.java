...
import vavi.sound.mfi.ucs.FuetrekRom.Sample;
import vavi.sound.mfi.ucs.FuetrekRom.Zone;
...
final class FuetrekVoice {
    ...
    private void updateMix() {
        ...
        mixLeft = Math.clamp(leftWord << 1, 0, 0x7fff);
        mixRight = Math.clamp(rightWord << 1, 0, 0x7fff);
    }
