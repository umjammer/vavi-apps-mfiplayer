...
the rohm sound source (faith Type 2, BU8788KN / BU8709KN of F504i ~ F901iS, D901i, P900i ~ P901iS, SH251i/505i) in pure java
...
- `vavi.sound.mfi.faith.path` ... the authoring tool's `Tools` directory, where `rt_synth_2.dll` is (see [faith](../faith/readme.md))
- `vavi.sound.mfi.rohm.dump` ... a file what is played is written to too, raw pcm 44.1 kHz 16 bit stereo little endian
