...
final class Ma7Dsp2 {
    ...
    private int b720b4() {
        ...
        x4 = ((int) x3 + 1) & 0xffffffffL; // 720c0: add w4, w3, #0x1
        { int fa = (int) x4, fb = 32; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 720c4: cmp w4, #0x20
    ...
    private int b720d0() {
        { int fa = (int) x4, fb = 1; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } x5 = ((int) x4 - 1) & 0xffffffffL; // 720d0: subs w5, w4, #0x1
        x6 = ((int) x4 + 31) & 0xffffffffL; // 720d4: add w6, w4, #0x1f
        x7 = ((n) ? (int) x6 : (int) x5) & 0xffffffffL; // 720d8: csel w7, w6, w5, mi
        x10 = (ld32((x1 + 2672))) & 0xffffffffL; // 720dc: ldr w10, [x1, #0xa70]
        { int fa = (int) x7, fb = 32; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 720e0: cmp w7, #0x20
        x8 = ((int) x7 & 31) & 0xffffffffL; // 720e4: and w8, w7, #0x1f
        x9 = ((c) ? (int) x8 : (int) x7) & 0xffffffffL; // 720e8: csel w9, w8, w7, hs
        x12 = ((int) x10 + 30) & 0xffffffffL; // 720ec: add w12, w10, #0x1e
        { int fa = (int) x10, fb = 2; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } x11 = ((int) x10 - 2) & 0xffffffffL; // 720f0: subs w11, w10, #0x2
        ...
        x14 = ((int) x13 & 31) & 0xffffffffL; // 72100: and w14, w13, #0x1f
        { int fa = (int) x13, fb = 32; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 72104: cmp w13, #0x20
    ...
    private int b7211c() {
        ...
        x18 = ((int) x20 - (int) x22) & 0xffffffffL; // 72124: sub w18, w20, w22
        { int fa = (int) x18, fb = 0; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 72128: cmp w18, wzr
        x12 = ((int) x18 + 32) & 0xffffffffL; // 7212c: add w12, w18, #0x20
        x9 = ((n != v) ? (int) x12 : (int) x18) & 0xffffffffL; // 72130: csel w9, w12, w18, lt
        { int fa = (int) x9, fb = 32; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 72134: cmp w9, #0x20
        x3 = ((int) x9 & 31) & 0xffffffffL; // 72138: and w3, w9, #0x1f
        ...
        x23 = ((int) x21 - (int) x23) & 0xffffffffL; // 72148: sub w23, w21, w23
        { int fa = (int) x23, fb = 0; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 7214c: cmp w23, wzr
        x4 = ((int) x23 + 32) & 0xffffffffL; // 72150: add w4, w23, #0x20
        x7 = ((n != v) ? (int) x4 : (int) x23) & 0xffffffffL; // 72154: csel w7, w4, w23, lt
        { int fa = (int) x7, fb = 32; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 72158: cmp w7, #0x20
        x28 = ((int) x7 & 31) & 0xffffffffL; // 7215c: and w28, w7, #0x1f
        ...
        x16 = ((int) x10 - (int) x16) & 0xffffffffL; // 7216c: sub w16, w10, w16
        { int fa = (int) x16, fb = 0; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 72170: cmp w16, wzr
        x5 = ((int) x16 + 32) & 0xffffffffL; // 72174: add w5, w16, #0x20
        x11 = ((n != v) ? (int) x5 : (int) x16) & 0xffffffffL; // 72178: csel w11, w5, w16, lt
        { int fa = (int) x11, fb = 32; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 7217c: cmp w11, #0x20
        x6 = ((int) x11 & 31) & 0xffffffffL; // 72180: and w6, w11, #0x1f
        ...
        x17 = ((int) x26 - (int) x17) & 0xffffffffL; // 72190: sub w17, w26, w17
        { int fa = (int) x17, fb = 0; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 72194: cmp w17, wzr
        x13 = ((int) x17 + 32) & 0xffffffffL; // 72198: add w13, w17, #0x20
        x24 = ((n != v) ? (int) x13 : (int) x17) & 0xffffffffL; // 7219c: csel w24, w13, w17, lt
        x8 = ((int) x24 & 31) & 0xffffffffL; // 721a0: and w8, w24, #0x1f
        { int fa = (int) x24, fb = 32; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 721a4: cmp w24, #0x20
    ...
    private int b721b4() {
        x18 = ((int) x15 - (int) x25) & 0xffffffffL; // 721b4: sub w18, w15, w25
        x19 = x27; // 721b8: mov x19, x27
        { int fa = (int) x18, fb = 0; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 721bc: cmp w18, wzr
        x20 = ((int) x18 + 32) & 0xffffffffL; // 721c0: add w20, w18, #0x20
        x21 = ((n != v) ? (int) x20 : (int) x18) & 0xffffffffL; // 721c4: csel w21, w20, w18, lt
        x22 = ((int) x25 + 1) & 0xffffffffL; // 721c8: add w22, w25, #0x1
        { int fa = (int) x21, fb = 32; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 721cc: cmp w21, #0x20
        x24 = ((int) x21 & 31) & 0xffffffffL; // 721d0: and w24, w21, #0x1f
        x26 = ((c) ? (int) x24 : (int) x21) & 0xffffffffL; // 721d4: csel w26, w24, w21, hs
        { int fa = (int) x22, fb = 24; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 721d8: cmp w22, #0x18
        st32(x19, (int) x26); x19 = x19 + 4; // 721dc: str w26, [x19], #0x4
        x16 = ((int) x25 + 3) & 0xffffffffL; // 721e0: add w16, w25, #0x3
        x17 = ((int) x25 + 4) & 0xffffffffL; // 721e4: add w17, w25, #0x4
        x23 = ((int) x22 + 1) & 0xffffffffL; // 721e8: add w23, w22, #0x1
        x25 = ((int) x25 + 5) & 0xffffffffL; // 721ec: add w25, w25, #0x5
    ...
    private int b721f4() {
        ...
        x28 = ((int) x27 + 1) & 0xffffffffL; // 721fc: add w28, w27, #0x1
        x2 = (ld32((x19 + 1068))) & 0xffffffffL; // 72200: ldr w2, [x19, #0x42c]
        x3 = ((int) x2 + 1) & 0xffffffffL; // 72204: add w3, w2, #0x1
        { int fa = (int) x3, fb = 32768; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 72208: cmp w3, #0x8, lsl #12
        ...
        { int fa = (int) x28, fb = -(1); int fr = fa - fb; n = fr < 0; z = fr == 0; c = Long.compareUnsigned((fa & 0xffffffffL) + ((-fb) & 0xffffffffL), 0xffffffffL) > 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 72218: cmn w28, #0x1
    ...
    private int b72220() {
        ...
        x9 = ((int) x8 + ((int) x8 << 1)) & 0xffffffffL; // 72234: add w9, w8, w8, lsl #1
    ...
    private int b72284() {
        ...
        x28 = (int) x26; // 7228c: sxtw x28, w26
    ...
    private int b722fc() {
        ...
        x17 = (int) x14; // 72304: sxtw x17, w14
    ...
    private int b72318() {
        ...
        x24 = (int) x22; // 72320: sxtw x24, w22
    ...
    private int b72334() {
        ...
        x14 = (int) x25; // 7233c: sxtw x14, w25
    ...
    private int b72398() {
        ...
        x21 = ld32((x0 + 13960)); // 7239c: ldrsw x21, [x0, #0x3688]
        x25 = v9l; // 723a0: fmov x25, d9
        x16 = ld32((x0 + 13964)); // 723a4: ldrsw x16, [x0, #0x368c]
        x4 = v8l; // 723a8: fmov x4, d8
        x15 = ld32((x0 + 13968)); // 723ac: ldrsw x15, [x0, #0x3690]
        x27 = v10l; // 723b0: fmov x27, d10
        x23 = ld32((x0 + 13980)); // 723b4: ldrsw x23, [x0, #0x369c]
        x9 = ld32((x0 + 13972)); // 723b8: ldrsw x9, [x0, #0x3694]
        x7 = ld32((x0 + 13976)); // 723bc: ldrsw x7, [x0, #0x3698]
    ...
    private int b7240c() {
        ...
        x7 = ((int) x21 + (int) x6) & 0xffffffffL; // 7244c: add w7, w21, w6
        x9 = ((int) x14 + (int) x22) & 0xffffffffL; // 72450: add w9, w14, w22
        ...
        x22 = ((int) x4 + (int) x24) & 0xffffffffL; // 72468: add w22, w4, w24
        ...
        x13 = ((int) x16 + (int) x13) & 0xffffffffL; // 724a4: add w13, w16, w13
        x16 = x9 >> 15; // 724a8: asr x16, x9, #15
        x14 = ((int) x26 + (int) x10) & 0xffffffffL; // 724ac: add w14, w26, w10
        x15 = ((int) x25 + (int) x27) & 0xffffffffL; // 724b0: add w15, w25, w27
        x20 = ((int) x28 + (int) x4) & 0xffffffffL; // 724b4: add w20, w28, w4
        x21 = ((int) x23 + (int) x7) & 0xffffffffL; // 724b8: add w21, w23, w7
        x22 = ((int) x12 + (int) x16) & 0xffffffffL; // 724bc: add w22, w12, w16
        return 0x724c0;
    }
    ...
    private int b72508() {
        ...
        { int fa = (int) x18, fb = 1; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 7251c: cmp w18, #0x1
        ...
        x24 = ((int) x4 + (int) x11) & 0xffffffffL; // 72554: add w24, w4, w11
        ...
        x11 = ((int) x16 + (int) x25) & 0xffffffffL; // 72584: add w11, w16, w25
        ...
        x24 = ((int) x24 + (int) x11) & 0xffffffffL; // 72594: add w24, w24, w11
        ...
        x23 = ((int) x25 + (int) x17) & 0xffffffffL; // 725c4: add w23, w25, w17
        x4 = (long) (int) x20 * (long) (int) x9; // 725c8: smull x4, w20, w9
        x9 = (ld32((x0 + 15724))) & 0xffffffffL; // 725cc: ldr w9, [x0, #0x3d6c]
        x14 = ((int) x14 + (int) x5) & 0xffffffffL; // 725d0: add w14, w14, w5
        ...
        x12 = ((int) x12 + (int) x8) & 0xffffffffL; // 725e4: add w12, w12, w8
        ...
        x26 = ((int) x26 + (int) x11) & 0xffffffffL; // 725f4: add w26, w26, w11
        ...
        x11 = ((int) x15 + (int) x20) & 0xffffffffL; // 72614: add w11, w15, w20
        ...
        x14 = ((int) x14 + (int) x7) & 0xffffffffL; // 72624: add w14, w14, w7
        ...
        x12 = ((int) x12 + (int) x8) & 0xffffffffL; // 72638: add w12, w12, w8
        ...
        x7 = ((int) x14 + (int) x28) & 0xffffffffL; // 72648: add w7, w14, w28
        x8 = (ld32((x1 + 2616))) & 0xffffffffL; // 7264c: ldr w8, [x1, #0xa38]
        x24 = ((int) x24 + (int) x23) & 0xffffffffL; // 72650: add w24, w24, w23
        ...
        x25 = ((int) x12 + (int) x16) & 0xffffffffL; // 7266c: add w25, w12, w16
        ...
        x26 = ((int) x26 + (int) x23) & 0xffffffffL; // 7268c: add w26, w26, w23
        x5 = x22 >> 15; // 72690: asr x5, x22, #15
        x28 = (long) (int) x20 * (long) (int) x12; // 72694: smull x28, w20, w12
        x10 = x4 >> 15; // 72698: asr x10, x4, #15
        x26 = ((int) x26 + (int) x5) & 0xffffffffL; // 7269c: add w26, w26, w5
        x24 = ((int) x24 + (int) x11) & 0xffffffffL; // 726a0: add w24, w24, w11
        ...
        x13 = ((int) x26 + (int) x10) & 0xffffffffL; // 726b4: add w13, w26, w10
        x11 = (ld32((x2 + 1104))) & 0xffffffffL; // 726b8: ldr w11, [x2, #0x450]
        x8 = ((int) x25 + (int) x12) & 0xffffffffL; // 726bc: add w8, w25, w12
        x6 = ((int) x7 + (int) x17) & 0xffffffffL; // 726c0: add w6, w7, w17
        x14 = ((int) x13 + (int) x19) & 0xffffffffL; // 726c4: add w14, w13, w19
        x7 = ((int) x6 + (int) x21) & 0xffffffffL; // 726c8: add w7, w6, w21
        x28 = ((int) x8 + (int) x23) & 0xffffffffL; // 726cc: add w28, w8, w23
        x24 = ((int) x24 + (int) x11) & 0xffffffffL; // 726d0: add w24, w24, w11
        x25 = ((int) x14 + (int) x16) & 0xffffffffL; // 726d4: add w25, w14, w16
    ...
    private int b726ec() {
        ...
        { int fa = (int) x15, fb = 1; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 726f0: cmp w15, #0x1
        if (z) { throw new IllegalStateException("procDsp2: 0x73d00"); } return 0x726f8;
    }

    private int b726f8() {
        { int fa = (int) x18, fb = 1; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 726f8: cmp w18, #0x1
    ...
    private int b72714() {
        ...
        x25 = ((int) x8 - 2) & 0xffffffffL; // 7272c: sub w25, w8, #0x2
        { int fa = (int) x25, fb = 2; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 72730: cmp w25, #0x2
        ...
        x16 = ((int) x20 + (int) x3) & 0xffffffffL; // 72754: add w16, w20, w3
        x5 = ((int) x9 + (int) x22) & 0xffffffffL; // 72758: add w5, w9, w22
    ...
    private int b727d8() {
        ...
        x11 = ((int) x10 + 1) & 0xffffffffL; // 727dc: add w11, w10, #0x1
        { int fa = (int) x11, fb = 32768; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 727e0: cmp w11, #0x8, lsl #12
    ...
    private int b72930() {
        ...
        x16 = ((int) x16 + (int) x2) & 0xffffffffL; // 72950: add w16, w16, w2
        x5 = ((int) x5 + (int) x10) & 0xffffffffL; // 72954: add w5, w5, w10
        return 0x72764;
    }
    ...
    private int b72988() {
        { int fa = (int) x4, fb = 1; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 72988: cmp w4, #0x1
        if (z) { throw new IllegalStateException("procDsp2: 0x77aec"); } return 0x72990;
    }

    private int b72990() {
        { int fa = (int) x4, fb = 2; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 72990: cmp w4, #0x2
        if (z) { throw new IllegalStateException("procDsp2: 0x73200"); } return 0x72998;
    }

    private int b72998() {
        { int fa = (int) x4, fb = 3; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 72998: cmp w4, #0x3
        if (z) { throw new IllegalStateException("procDsp2: 0x775b4"); } return 0x729a0;
    }

    private int b729a0() {
        { int fa = (int) x4, fb = 4; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 729a0: cmp w4, #0x4
        if (z) { throw new IllegalStateException("procDsp2: 0x77108"); } return 0x729a8;
    }

    private int b729a8() {
        { int fa = (int) x4, fb = 5; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 729a8: cmp w4, #0x5
        if (z) { throw new IllegalStateException("procDsp2: 0x76d70"); } return 0x729b0;
    }

    private int b729b0() {
        { int fa = (int) x4, fb = 6; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 729b0: cmp w4, #0x6
        if (z) { throw new IllegalStateException("procDsp2: 0x769fc"); } return 0x729b8;
    }

    private int b729b8() {
        { int fa = (int) x4, fb = 8; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 729b8: cmp w4, #0x8
        if (z) { throw new IllegalStateException("procDsp2: 0x769ec"); } return 0x729c0;
    }

    private int b729c0() {
        { int fa = (int) x4, fb = 7; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 729c0: cmp w4, #0x7
        if (z) { throw new IllegalStateException("procDsp2: 0x783a0"); } return 0x729c8;
    }

    private int b729c8() {
        { int fa = (int) x4, fb = 9; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 729c8: cmp w4, #0x9
    ...
    private int b729dc() {
        ...
        x26 = ld32((x0 + 13948)); // 729ec: ldrsw x26, [x0, #0x367c]
        ...
        x10 = ((int) x20 + (int) x13) & 0xffffffffL; // 72a04: add w10, w20, w13
        x16 = x12 >> 15; // 72a08: asr x16, x12, #15
        x23 = ((int) x10 + (int) x16) & 0xffffffffL; // 72a0c: add w23, w10, w16
    ...
    private int b72a1c() {
        { int fa = (int) x10, fb = 1; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 72a1c: cmp w10, #0x1
        if (z) { throw new IllegalStateException("procDsp2: 0x7632c"); } return 0x72a24;
    }

    private int b72a24() {
        { int fa = (int) x10, fb = 2; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 72a24: cmp w10, #0x2
        if (z) { throw new IllegalStateException("procDsp2: 0x76320"); } return 0x72a2c;
    }

    private int b72a2c() {
        { int fa = (int) x10, fb = 3; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 72a2c: cmp w10, #0x3
    ...
    private int b72a60() {
        ...
        x7 = ((int) x11 - 1) & 0xffffffffL; // 72a6c: sub w7, w11, #0x1
        x12 = ((int) x11 - 2) & 0xffffffffL; // 72a70: sub w12, w11, #0x2
        { int fa = (int) x7, fb = 0; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 72a74: cmp w7, wzr
        x26 = ((int) x7 + 32768) & 0xffffffffL; // 72a78: add w26, w7, #0x8, lsl #12
        x19 = ((n != v) ? (int) x26 : (int) x7) & 0xffffffffL; // 72a7c: csel w19, w26, w7, lt
        x10 = ((int) x12 + 32768) & 0xffffffffL; // 72a80: add w10, w12, #0x8, lsl #12
        ...
        x28 = ((int) x19 & (int) x25) & 0xffffffffL; // 72a88: and w28, w19, w25
        x27 = ((c && !z) ? (int) x28 : (int) x19) & 0xffffffffL; // 72a8c: csel w27, w28, w19, hi
        { int fa = (int) x12, fb = 0; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 72a90: cmp w12, wzr
        x24 = ((n != v) ? (int) x10 : (int) x12) & 0xffffffffL; // 72a94: csel w24, w10, w12, lt
        x6 = (ld32((x1 + 2676))) & 0xffffffffL; // 72a98: ldr w6, [x1, #0xa74]
        x9 = ((int) x24 & (int) x25) & 0xffffffffL; // 72a9c: and w9, w24, w25
    ...
    private int b72b74() {
        x25 = ((int) x11 - (int) x4) & 0xffffffffL; // 72b74: sub w25, w11, w4
        x12 = ((int) (short) ld16((x1 + 2468))) & 0xffffffffL; // 72b78: ldrsh w12, [x1, #0x9a4]
        { int fa = (int) x25, fb = 0; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 72b7c: cmp w25, wzr
        x16 = ((int) x25 + 32768) & 0xffffffffL; // 72b80: add w16, w25, #0x8, lsl #12
        x10 = (n != v) ? x16 : x25; // 72b84: csel x10, x16, x25, lt
        x28 = (32767) & 0xffffffffL; // 72b88: mov w28, #0x7fff
        x19 = ((int) x10 & 32767) & 0xffffffffL; // 72b8c: and w19, w10, #0x7fff
    ...
    private int b72c60() {
        ...
        x11 = ((int) x11 - (int) x12) & 0xffffffffL; // 72c8c: sub w11, w11, w12
        ...
        { int fa = (int) x11, fb = 0; int fr = fa - fb; n = fr < 0; z = fr == 0; c = Integer.compareUnsigned(fa, fb) >= 0; v = ((fa ^ fb) & (fa ^ fr)) < 0; } // 72cb8: cmp w11, wzr
        x4 = ((int) x11 + 32768) & 0xffffffffL; // 72cbc: add w4, w11, #0x8, lsl #12
        ...
        x12 = ((int) x11 & (int) x10) & 0xffffffffL; // 72cf8: and w12, w11, w10
        ...
        x10 = ((int) x4 + (int) x10) & 0xffffffffL; // 72d84: add w10, w4, w10
        x27 = ((int) x10 + (int) x27) & 0xffffffffL; // 72d88: add w27, w10, w27
        x12 = x12 >> 15; // 72d8c: asr x12, x12, #15
        x12 = ((int) x27 + (int) x12) & 0xffffffffL; // 72d90: add w12, w27, w12
        x11 = ((int) x12 + (int) x28) & 0xffffffffL; // 72d94: add w11, w12, w28
        ...
        x27 = ((int) x10 + (int) x11) & 0xffffffffL; // 72dcc: add w27, w10, w11
        x10 = ((int) x27 + (int) x4) & 0xffffffffL; // 72dd0: add w10, w27, w4
        ...
        x28 = ((int) x4 + (int) x28) & 0xffffffffL; // 72e34: add w28, w4, w28
        x27 = ((int) x28 + (int) x27) & 0xffffffffL; // 72e38: add w27, w28, w27
        x12 = ((int) x27 + (int) x12) & 0xffffffffL; // 72e3c: add w12, w27, w12
        x11 = ((int) x12 + (int) x11) & 0xffffffffL; // 72e40: add w11, w12, w11
        ...
        x16 = ((int) x16 + (int) x11) & 0xffffffffL; // 72e84: add w16, w16, w11
        x4 = (long) (int) x28 * (long) (int) x4; // 72e88: smull x4, w28, w4
        x28 = x27 >> 15; // 72e8c: asr x28, x27, #15
        x27 = x12 >> 15; // 72e90: asr x27, x12, #15
        x11 = ((int) x16 + (int) x28) & 0xffffffffL; // 72e94: add w11, w16, w28
        x12 = x4 >> 15; // 72e98: asr x12, x4, #15
        x4 = ((int) x11 + (int) x27) & 0xffffffffL; // 72e9c: add w4, w11, w27
        x16 = ((int) x4 + (int) x12) & 0xffffffffL; // 72ea0: add w16, w4, w12
        ...
        x11 = ((int) x4 + (int) x28) & 0xffffffffL; // 72ed0: add w11, w4, w28
        x16 = x12 >> 15; // 72ed4: asr x16, x12, #15
        x27 = ((int) x11 + (int) x16) & 0xffffffffL; // 72ed8: add w27, w11, w16
        ...
        x19 = ((int) x12 + (int) x4) & 0xffffffffL; // 72f04: add w19, w12, w4
        ...
        x28 = ((int) x28 + (int) x11) & 0xffffffffL; // 72f6c: add w28, w28, w11
        x11 = ((int) x28 + (int) x25) & 0xffffffffL; // 72f70: add w11, w28, w25
        x19 = x12 >> 15; // 72f74: asr x19, x12, #15
        x26 = ((int) x11 + (int) x19) & 0xffffffffL; // 72f78: add w26, w11, w19
        x12 = x4 >> 15; // 72f7c: asr x12, x4, #15
        x28 = ((int) x26 + (int) x12) & 0xffffffffL; // 72f80: add w28, w26, w12
        ...
        x25 = ((int) x24 + (int) x4) & 0xffffffffL; // 72fbc: add w25, w24, w4
        x24 = ((int) x25 + (int) x12) & 0xffffffffL; // 72fc0: add w24, w25, w12
    ...
    private int b73000() {
        ...
        x28 = ((int) x28 + (int) x25) & 0xffffffffL; // 7300c: add w28, w28, w25
        x4 = (long) (int) x4 * (long) (int) x19; // 73010: smull x4, w4, w19
        x19 = x12 >> 15; // 73014: asr x19, x12, #15
        x12 = x11 >> 15; // 73018: asr x12, x11, #15
        x25 = ((int) x28 + (int) x19) & 0xffffffffL; // 7301c: add w25, w28, w19
        x11 = x4 >> 15; // 73020: asr x11, x4, #15
        x4 = ((int) x25 + (int) x12) & 0xffffffffL; // 73024: add w4, w25, w12
        x28 = ((int) x4 + (int) x11) & 0xffffffffL; // 73028: add w28, w4, w11
        ...
        x28 = ((int) x28 + (int) x9) & 0xffffffffL; // 73068: add w28, w28, w9
        ...
        x9 = ((int) x28 + (int) x19) & 0xffffffffL; // 7307c: add w9, w28, w19
        x11 = x4 >> 15; // 73080: asr x11, x4, #15
        x25 = ((int) x9 + (int) x12) & 0xffffffffL; // 73084: add w25, w9, w12
        x28 = ((int) x25 + (int) x11) & 0xffffffffL; // 73088: add w28, w25, w11
        ...
        x19 = ((int) x11 + (int) x12) & 0xffffffffL; // 730b8: add w19, w11, w12
        x4 = x9 >> 15; // 730bc: asr x4, x9, #15
        x28 = ((int) x19 + (int) x4) & 0xffffffffL; // 730c0: add w28, w19, w4
        ...
        x9 = ((int) x12 + (int) x4) & 0xffffffffL; // 730e8: add w9, w12, w4
        ...
        x19 = ((int) x4 + 32768) & 0xffffffffL; // 73120: add w19, w4, #0x8, lsl #12
        ...
        x25 = ((int) x26 + (int) x6) & 0xffffffffL; // 7312c: add w25, w26, w6
        x11 = x28 >> 15; // 73130: asr x11, x28, #15
        x28 = ((int) x25 + (int) x7) & 0xffffffffL; // 73134: add w28, w25, w7
        x26 = ((int) x28 + (int) x11) & 0xffffffffL; // 73138: add w26, w28, w11
    ...
    private int b73158() {
        ...
        x9 = ((int) x25 + (int) x9) & 0xffffffffL; // 73188: add w9, w25, w9
        ...
        x10 = ((int) x19 + (int) x28) & 0xffffffffL; // 731a0: add w10, w19, w28
        x24 = (ld32((x0 + 15948))) & 0xffffffffL; // 731a4: ldr w24, [x0, #0x3e4c]
        x11 = x27 >> 15; // 731a8: asr x11, x27, #15
        x27 = ((int) x10 + (int) x12) & 0xffffffffL; // 731ac: add w27, w10, w12
        x19 = ((int) x27 + (int) x11) & 0xffffffffL; // 731b0: add w19, w27, w11
        ...
        x4 = ((int) x28 + (int) x25) & 0xffffffffL; // 731d4: add w4, w28, w25
